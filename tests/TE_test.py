...
class TransEfficiency(unittest.TestCase):
    ...
    def testTransEfficiency(self):
        ...
        test_cmd = "python src/ribodiff/functional_test_te.py -e tests/experimental_design.csv -c tests/test_gene_count_table.txt -o tests/test_result.txt -d 0 -r 1 -p 1 -q 0.1"
