...
def write_result(data, opts):
    ...
    if opts.dispDiff:
        ...
        header = 'geneIDs\tdisperRawRibo\tdisperRawRNA\tdisperRawMthd\tdisperRawConverge\tdisperFittedRibo\tdisperFittedRNA\tdisperAdjRibo\tdisperAdjRNA\tdisperAdjMthd\tdisperAdjConverge\tpval\tpadj\tTE%s\tTE%s\tlog2FC_TE(%s vs %s)\t' % (nameCondA, nameCondB, nameCondB, nameCondA) + sampleNameRibo + '\t' + sampleNameRna
    else:
        ...
        header = 'geneIDs\tdisperRaw\tdisperRawConverge\tdisperFitted\tdisperAdj\tdisperAdjConverge\tpval\tpadj\tTE%s\tTE%s\tlog2FC_TE(%s vs %s)\t' % (nameCondA, nameCondB, nameCondB, nameCondA) + sampleNameRibo + '\t' + sampleNameRna
