...
python nbinom_count_generator.py --numEntry 10000 --numSampleConA 3 --numSampleConB 3 --output ../exp/Sim/Sim.Ribo.Rep3.G10K.Diff5K.Sh1.5.Sc0.5.cnt.txt --nParamNB 0.5 --pParamNB 0.008 --beta1 0.1 --beta2 0.0001 --numDiff 5000 --shapeGamma 1.5 --scaleGamma 0.5
