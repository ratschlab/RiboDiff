...
write.table(as.data.frame(between.babel[[1]]), sep = '\t', file='/cbio/grlab/home/zhongyi/git/projects/2014/ribosomefootprinting/exp/Sim/Sim.Merged.Rep3.G10K3.Diff1KRb.Sh1.5.Sc0.5.res.babel.txt')
